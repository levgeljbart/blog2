...
sections:
  - block: about.avatar
    ...
    content:
      ...
      text: Cтудент первого курса математики и механики, по совместительству начинающий дизайнер.
    ...
    content:
      ...
      items:
        - title: Ассистент дизайнера
          ...
          company_url: 'https://t.me/vadimmerlis'
          company_logo: 'merlis'
          location: Москва
  ...
  - block: accomplishments
    content:
      ...
      #   Begin multi-line descriptions with YAML's `|2-` multi-line prefix.
      items:
        - certificate_url: https://conf.profil.mos.ru/kur
          date_end: ''
          date_start: '2022-03-03'
          description: Победитель научно-технической конференции "Курчатовский проект - от знаний к практике, от практики к результату"
        ...
        - certificate_url: https://conf.profil.mos.ru/academ
          date_end: ''
          date_start: '2022-03-03'
        ...
        - certificate_url: https://conf.profil.mos.ru/inj
          date_end: ''
          date_start: '2022-03-03'
